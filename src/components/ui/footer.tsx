            ...
            <div className='container mx-auto px-4 md:px-6'>
                <div className='grid grid-cols-1 gap-8 md:grid-cols-4'>
                    ...
                    <div className='space-y-4'>
                        ...
                        <ul className='space-y-2 text-sm'>
                            <li>
                                <a href="mailto:heterox@qq.com" className='text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-600'>
                                    联系我
                                </a>
                            </li>
                            <li>
                    ...
                    <div className='space-y-4'>
                        ...
                        <form action="">
                            <div className='flex space-x-2'>
                                <Input type='email' placeholder='请输入邮箱地址' className='flex-1'/>
                                <Button>订阅</Button>
                            </div>
                        </form>
                    </div>
                </div>
                <div className='mt-8 border-t border-gray-300 pt-4 text-center text-xs text-gray-700 dark:text-gray-400 dark:border-gray-700'>
